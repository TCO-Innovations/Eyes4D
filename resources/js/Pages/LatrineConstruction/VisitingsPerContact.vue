<template>
    <div class="shadow-lg">
        <header class="flex justify-between px-4 py-5 bg-blue-100">
            <h3 class="text-xs uppercase tracking-wide font-semibold text-blue-700">Visiting Per Contact</h3>
            <div class="text-xs">
        ...
        <div class="py-4 px-4">
            <table class="w-full text-left">
                <tbody>
                    <tr class="border-b">
                        <th class="text-xs uppercase tracking-wider font-light text-gray-600 py-4">Contact</th>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            fetchResult() {
                axios.get("api/visiting_per_contact", {
                    params: {
                        take: this.limit,
                        order: this.order
                    }
