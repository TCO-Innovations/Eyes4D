            ...
            <div class="flex mb-16 -mx-6">
                <section class="w-1/2 px-6">
                    <div class="shadow-lg rounded px-6 py-6">
                        <h1>Handwashing station next to the Latrine</h1>
                    </div>
                </section>

                <section class="w-1/2 px-6">
                    <div class="shadow-lg rounded px-6 py-6">
                        <h1>Handwashing station distribution</h1>
                    </div>
                </section>
            </div>
