...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    fetchResult: function fetchResult() {
      var response;
      return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.async(function fetchResult$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              _context.next = 2;
              return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.awrap(axios__WEBPACK_IMPORTED_MODULE_2___default.a.get("api/visiting_per_contact", {
                params: {
                  take: this.limit,
                  order: this.order
                }
