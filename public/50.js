...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    handlingCreating: function handlingCreating() {}
  }
});
            ...
            "button",
            {
              ...
              on: {
                click: function($event) {
                  ...
                  return _vm.handlingCreating($event)
                }
              }
            },
            [
            ...
            _c("thead", [
              _c("tr", [
                _c(
                  ...
                  {
                    staticClass:
                      "text-left py-3 px-4 text-xs uppercase tracking-wide text-gray-600 font-medium bg-gray-100"
                  },
                  [_vm._v("Name")]
                ),
                _vm._v(" "),
            ...
            _c(
              ...
              _vm._l(_vm.users, function(user) {
                return _c("tr", { key: user.id }, [
                  _c("td", { staticClass: "py-3 px-4 text-sm" }, [
                  ...
                  _vm._v(" "),
                  _c("td", { staticClass: "py-3 px-4 text-sm text-right" }, [
                    _c(
                      "a",
                      {
                        staticClass:
